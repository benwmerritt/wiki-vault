...
aliases: []
created: 2025-09-02
title: Anthropic Claude Prompting Guide
modified: 2025-09-12
---
...
### Brainstorming
 1. Use Claude to generate ideas by asking for a list of possibilities or alternatives.
   ...
   2. Suggesting 10 virtual team-building activities that promote collaboration
   3. For each activity, briefly explain how it fosters teamwork
   4. Indicate which activities are best for:
	  a) Ice-breakers
	  b) Improving communication
	  c) Problem-solving skills
   5. Suggest one low-cost option and one premium option."
   </prompt>
...
6. Request responses in specific formats like bullet points, numbered lists, or tables for easier reading.
   ...
   8. Ease of Use
   9. Scalability
   10. Pricing (include specific plans if possible)
   11. Integration capabilities
   12. Best suited for (e.g., small teams, enterprise, specific industries)"
   </prompt>
